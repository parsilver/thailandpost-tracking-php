...
namespace Farzai\ThaiPost\Webhook\Auth;
...
class SessionToken implements TokenStore
{
    ...
    {
        $_SESSION['THAIPOST_WEBHOOK_TOKEN'] = $token->asJson();
    }
    ...
    public function get()
    {
        $json = @json_decode($_SESSION['THAIPOST_WEBHOOK_TOKEN'] ?? '', true);
    ...
    public function has()
    {
        return ! is_null($_SESSION['THAIPOST_WEBHOOK_TOKEN'] ?? null);
    }
}